                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    >
                        ...
                        <div className="space-y-4 mb-8">
                            <button className="btn-primary w-full py-4 flex items-center justify-center space-x-3 text-base">
                                <Calendar size={20} />
                        ...
                        <div className="space-y-4 pt-6 border-t border-health-border">
                            <div className="flex items-center justify-between text-xs">
                                ...
                                <span className="font-bold text-primary-navy">$25.00</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="mt-8">
                            <AlertBanner
                                ...
                                message="Benefit from our exclusive partnership with Mercy General for faster scheduling."
                            />
                        </div>
                    </motion.div>

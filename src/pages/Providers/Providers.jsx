...
const sampleProviders = [
    { id: 1, name: 'Dr. Sarah Jenkins', specialty: 'Cardiologist', yearsExp: 15, rating: 4.8, reviewCount: 124, hospital: 'Apollo Hospitals', city: 'Mumbai', badge: 'Excellent' },
    { id: 2, name: 'Dr. Michael Chen', specialty: 'Dermatologist', yearsExp: 8, rating: 5.0, reviewCount: 89, hospital: 'Fortis Healthcare', city: 'Delhi', badge: 'Top Rated' },
    { id: 3, name: 'Dr. Emily Carter', specialty: 'Pediatrician', yearsExp: 12, rating: 4.2, reviewCount: 56, hospital: "Manipal Hospital", city: 'Bangalore' },
    { id: 4, name: 'Dr. David Ross', specialty: 'Orthopedist', yearsExp: 20, rating: 4.7, reviewCount: 210, hospital: 'Max Super Speciality', city: 'Gurgaon', badge: 'Available Today' },
    { id: 5, name: 'Dr. Amanda Lee', specialty: 'General Practitioner', yearsExp: 6, rating: 4.1, reviewCount: 42, hospital: 'Medanta', city: 'Lucknow' },
    { id: 6, name: 'Dr. James Wilson', specialty: 'Neurologist', yearsExp: 25, rating: 4.9, reviewCount: 315, hospital: 'Aster CMI', city: 'Hyderabad', badge: 'Specialist' },
    { id: 7, name: 'Dr. Rebecca Tran', specialty: 'Optometrist', yearsExp: 5, rating: 4.5, reviewCount: 28, hospital: 'Narayana Health', city: 'Kolkata' },
    { id: 8, name: 'Dr. Thomas Clark', specialty: 'Dentist', yearsExp: 10, rating: 4.9, reviewCount: 92, hospital: 'Sir H. N. Reliance', city: 'Mumbai', badge: 'High Demand' },
];
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 space-y-4 md:space-y-0 text-center md:text-left">
                ...
                <div className="text-sm font-bold text-health-text-muted uppercase tracking-widest">
                    Showing <span className="text-primary-navy">{filteredProviders.length} results</span>
                </div>
            </div>
